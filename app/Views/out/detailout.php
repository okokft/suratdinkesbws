...
<div class="container">
    ...
    <form action="#" method="post">     
        ...
        <div class="form-group">
          <label for="asal">tujuan</label>
            <input type="text" class="form-control" name="asal" required="required" readonly value="<?php echo $data['tujuan']; ?>">
        </div>
        <div class="form-group">
    ...
    <div>
        <a href="<?= base_url('/suratout'),"/",session('tahun')?>" class="btn btn-success btn-block">Kembali</a>
    </div>    
    <br/>
